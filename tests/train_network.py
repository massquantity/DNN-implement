...
if __name__ == "__main__":
    ...
    dnn = Network_mini_batch(sizes=[3072, 50, 10], activation="elu", alpha=0.01)
    optimizer = Momentum(lr=1e-3, momentum=0.9, batch_size=128)
    train_DNN_minibatch(X_train, y_train, 100, optimizer, 128, dnn, X_test, y_test)  # lr_decay_rate=0.95
    print()
